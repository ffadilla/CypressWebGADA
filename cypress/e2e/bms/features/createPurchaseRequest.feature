Feature: Create Purchase Request
  ...
  Scenario Outline: Create purchase request
    ...
    And user fills "deliveryFee" input field with 5 digits random number
    And user fills "deliveryFeeDiscount" input field with 4 digits random number
    And user fills "unloadingFee" input field with 5 digits random number
    And user fills "purchaseDiscount" input field with 4 digits random number
    ...
    And user fills selling estimation days input field with 2 digits random number
