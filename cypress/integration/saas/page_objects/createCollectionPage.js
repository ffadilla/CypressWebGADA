...
export default class CreateCollectionPage extends BasePage {
  ...
  fillCreateCollectionForm(credType) {
    cy.get(this.businessUnitIdInput)
      .type(businessUnitId)
      .get(this.requestIdInput)
      .type(requestId)
      .get(this.referenceIdInput)
      .type(referenceId)
      .get(this.recipientNameInput)
      .type(recipientName)
      .get(this.descriptionInput)
      .type(description)
      .get(this.itemNameInput)
      .type(itemName)
      .get(this.itemAmountInput)
      .type(itemAmount)
      .get(this.dueDateInput)
      .type(dueDate);
  }
